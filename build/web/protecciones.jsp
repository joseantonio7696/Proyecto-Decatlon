<%-- 
    Document   : protecciones
    Created on : 30-dic-2021, 16:14:57
    Author     : josea
--%>
...
//    Usuario usuario = (Usuario) getServletContext().getAttribute("usuario");
    ...
    ArrayList<Producto> listado= DAO.DbConnection.consultarProductos("4");
...
<html lang="en">
    <head>
        ...
        <title>PROTECCIONES-DECATLON</title>
        <!-- Favicon-->
        ...
        <header class="py-5" >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white rounded-pill" style="background-color: #0198f1 ">
                    <h1 class="display-4 fw-bolder">PROTECCIONES DEPORTIVAS</h1>
                    <p class="lead fw-normal text-white-50 mb-0">EQUIPATE CON LAS MEJORES PROTECCIONES DEPORTIVAS QUE PUEDAS ENCONTRAR, CUIDA TU CUERPO EN EL ENTRENO</p>
                </div>
            </div>
        </header>
        <!-- Section-->
