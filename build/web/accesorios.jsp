<%-- 
    Document   : accesorios
    Created on : 30-dic-2021, 16:10:21
    Author     : josea
--%>
...
//    Usuario usuario = (Usuario) getServletContext().getAttribute("usuario");
    ...
    if (usuario == null) {
        ...
        ArrayList<Producto> listado = DAO.DbConnection.consultarProductos("1");
...
<html lang="en">
    <head>
        ...
        <title>ACCESORIOS-DECATLON</title>
        <!-- Favicon-->
        ...
        <header class="py-5" >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white rounded-pill" style="background-color: #0198f1 ">
                    <h1 class="display-4 fw-bolder">ACCESORIOS DEPORTIVOS</h1>
                    <p class="lead fw-normal text-white-50 mb-0">AQUI PODRAS ENCONTRAR DIFERENTES ACCESORIOS DEPORTIVOS QUE TE HARAN MUCHO MAS FACIL TU ENTRENAMIENTO</p>
                </div>
            </div>
        </header>
