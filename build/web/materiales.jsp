<%-- 
    Document   : materiales
    Created on : 30-dic-2021, 15:19:55
    Author     : josea
--%>
...
//    Usuario usuario = (Usuario) getServletContext().getAttribute("usuario");
    ...
    ArrayList<Producto> listado= DAO.DbConnection.consultarProductos("2");
...
<html lang="en">
    <head>
        ...
        <title>MATERIALES-DECATLON</title>
        <!-- Favicon-->
        ...
        <header class="py-5" >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white rounded-pill" style="background-color: #0198f1 ">
                    <h1 class="display-4 fw-bolder">MATERIALES DEPORTIVOS</h1>
                    <p class="lead fw-normal text-white-50 mb-0">AQUI PODRAS ENCONTRAR DIFERENTES MATERIALES PARA EL ENTRENAMIENTO QUE QUIERAS REALIZAR</p>
                </div>
            </div>
        </header>
        <!-- Section-->
