<%-- 
    Document   : singular
    Created on : 30-dic-2021, 16:15:26
    Author     : josea
--%>
...
//    Usuario usuario = (Usuario) getServletContext().getAttribute("usuario");
    ...
    ArrayList<Producto> listado= DAO.DbConnection.consultarProductos("5");
...
<html lang="en">
    <head>
        ...
        <title>SINGULAR WOD-DECATLON</title>
        <!-- Favicon-->
        ...
        <header class="py-5" >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white rounded-pill" style="background-color: #0198f1 ">
                    <h1 class="display-4 fw-bolder">SINGULAR WOD</h1>
                    <p class="lead fw-normal text-white-50 mb-0">EN ESTA SECCION ENCONTRAMOS LOS MATERIALES MAS POPULARES PARA PODER HACER ENTRENAMIENTO SINGULAR-WOD</p>
                </div>
            </div>
        </header>
        <!-- Section-->
